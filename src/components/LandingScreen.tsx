    ...
    <div className="flex h-screen w-screen items-center justify-center bg-navy p-4">
      ...
      >
        <div className="flex items-center gap-3 border-b border-line px-5 py-4">
          ...
          <div>
            <h1 className="text-[0.95rem] font-extrabold leading-tight tracking-tight">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <input
                ...
                className="min-h-11 w-full rounded-lg border border-line bg-bg px-3 py-2 text-sm text-ink focus:border-cyan"
              />
              {touched && !name.trim() && (
